...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in counties_list:
        ...
        if (total_county_votes > largest_turnout_county_votes) and (county_vote_percentage > largest_turnout_percentage):
            largest_turnout_county_votes = total_county_votes
